...
object Main{
    ...
    args.toList match {
      ...
      case _  :: singleArg :: Nil => {
        ...
        singleArg match {
          // ........................................
          // ........................................
          case "day1-pt1" => day1part1()
          case "day1-pt2" => day1part2()
          // ........................................
          // ........................................
  ...
  def getDay1InputStringList():List[String]={
    // simpler
    List(
      ...
      "5cfprzgxtf3465five"
    ) // end day1InputAsStringList
  }
  def getDay1InputStringListPart2():List[String]={
    // simpler
    List(
      "51591twosix4dhsxvgghxq",
      "425nine",
      ...
      "3two3eightjszbfourkxbh5twonepr",
      "5cfprzgxtf3465five"
    ) // end day1InputAsStringListPart2
  }
  
  def getDay1TestInput():List[String]={
    List(
      "1abc2",
      "pqr3stu8vwx",
      "a1b2c3d4e5f",
  ...
  def getDay1TestInputPart2():List[String]={
    List(
      "two1nine",
      "eightwothree",
      "abcone2threexyz",
  ...
  // def firstDigitFromString(lineToFindFirstDigit:String):Int={
  //   // : first digit starting from fist char forwards

  //   // lineToFindFirstDigit.length match {
  //   //   case moreThanOne => {
  //   //     //...
  //   //   }
  //   //   case 0 => 0
  ...
  // }
  // def lastDigitFromString(lineToFindLastDigit:String):Int={
  //   // : last digit starting from last char backwards
  //   0
  // }

  def digitNameAsInt(digitName:String):Int={
  ...
  // TODO: modify to do part two
  def day1AccumulateList(listToProcess:List[String],valueSoFar:Int):Int={
    
    def handleInputSingleLine(lineToHandle:String):Int={

      // tbh just assume that it's always got the thing in it to find
      var digitsList = digitMatcher.r.findAllIn(lineToHandle).toList
    ...
    listToProcess match {
      case Nil => valueSoFar
      case head :: rest => day1AccumulateList(rest,( valueSoFar + handleInputSingleLine(head) ))
    }
  }

  def day1part1():Unit={
    // TODO: use input from file
    // readLinesFromFile("src/main/scala/inputs/day1_pt1.txt")


    
    // hand off to function
    var inputLines = getDay1InputStringList()
    // var inputLines = getDay1TestInput()
  ...
  def handleInputSingleLinePart2(lineToHandle:String):Int={
    ...
    // tbh just assume that it's always got the thing in it to find
    var digitsList = digitAndNameMatcher.findAllIn(lineToHandle).toList

    var headDigit = digitsList.head
    var lastDigit = digitsList.last

    var convertedHead = if(headDigit.matches(digitMatcher)) headDigit.toInt else digitNameAsInt(headDigit)
    var convertedLast = if(lastDigit.matches(digitMatcher)) lastDigit.toInt else digitNameAsInt(lastDigit)
    // var convertedTotal = convertedHead+convertedLast
    // forgor to *10 the first one
    var convertedTotal = (convertedHead*10)+convertedLast
    // .. testing
