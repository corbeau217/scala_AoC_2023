...
object Day1 {
  ...
  // simpler handle of the input data

  def day1InputAsStringList = List(
  ...
  def day1TestInput1AsStringList = List(
    "1abc2",
    "pqr3stu8vwx",
    "a1b2c3d4e5f",
    "treb7uchet"
  ) // end day1TestInput1AsStringList

  def day1TestInput2AsStringList = List(
    "two1nine",
    "eightwothree",
    "abcone2threexyz",
    "xtwone3four",
    ...
    "zoneight234",
    "7pqrstsixteen"
  ) // end day1TestInput2AsStringList
